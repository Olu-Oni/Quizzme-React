...
const MyNotification = ({ notification, setNotification, time, children }) => {
  ...
  return (
    <div
      ...
      } fixed bottom-3 left-3 flex flex-col bg-white text-green-400 rounded-lg duration-500 h-32 max-md:w-[80%] w-[50%] outline outline-2 outline-slate-300 z-30 -translate-x-[110%] overflow-hidden text-center`}
    >
      {children}
